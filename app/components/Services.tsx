      ...
      <div className="mx-auto max-w-7xl px-6 py-20 lg:px-8 lg:py-28">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          {services.map((service, index) => (
            <Reveal key={service.number} delay={(index % 3) * 100}>
              <article className="rounded-3xl border border-brand-200 bg-white p-8 transition hover:-translate-y-1 hover:shadow-xl">
